...
public class CourseL extends Course
{
    ...
    public CourseL(String courseTitle, String courseCode, int section, int timeFrom, int timeTo, String weekDay, int labTimeFrom, int labTimeTo, String labWeekDay)
    {
        super(courseTitle, courseCode, section, timeFrom, timeTo, weekDay);
