...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.courseViewHolder>
{
    ...
    public class courseViewHolder extends RecyclerView.ViewHolder
    {
        ...
        {
            super(itemView);
            txtHeader = (TextView) itemView.findViewById(R.id.header_line);
            textC1 = (TextView) itemView.findViewById(R.id.first_line);
            textC2 = (TextView) itemView.findViewById(R.id.second_line);
            textC3 = (TextView) itemView.findViewById(R.id.third_line);
            textC4 = (TextView) itemView.findViewById(R.id.fourth_line);
